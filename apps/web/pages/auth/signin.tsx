    ...
    return (
      <>
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <TerminalLoader 
            stages={[
              { message: 'VERIFYING CREDENTIALS...', duration: 600 },
              { message: 'DECRYPTING SESSION TOKEN...', duration: 500 },
              { message: 'ESTABLISHING SECURE LINK...', duration: 700 },
          ...
          <form onSubmit={handleSubmit} className="hud-card animate-fade-in">
            ...
            <div className="space-y-4">
              ...
              <p className="font-mono text-tactical-xs text-center text-ops-night-muted">
                PASSWORDLESS • SECURE SESSION VERIFIED
              </p>
            </div>
          </form>
