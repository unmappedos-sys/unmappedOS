...
describe('Confidence Engine', () => {
  ...
  describe('applyDailyDecay', () => {
    it('should apply base decay rate', () => {
      const zones = [
        { id: '1', score: 80, last_intel: new Date(Date.now() - 48 * 60 * 60 * 1000).toISOString() },
        { id: '2', score: 60, last_intel: new Date(Date.now() - 72 * 60 * 60 * 1000).toISOString() },
      ];
    ...
    it('should not decay zones with recent intel', () => {
      const zones = [
        { id: '1', score: 80, last_intel: new Date().toISOString() },
      ];
    ...
    it('should never decay below minimum score', () => {
      const zones = [
        { id: '1', score: 5, last_intel: new Date('2020-01-01').toISOString() },
      ];
